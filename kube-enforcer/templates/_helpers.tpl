...
Will be use serviceAccount with name "khulnasoft-kube-enforcer-sa" - the default serviceAccount
...
{{- else if not .Values.serviceAccount.create -}}
    {{ .Values.serviceAccount.name | default (printf "khulnasoft-kube-enforcer-sa") }}
{{- end -}}
{{- end -}}
...
{{- else if not .Values.global.imageCredentials.create -}}
    {{ .Values.global.imageCredentials.name | default (printf "khulnasoft-registry-secret") }}
{{- end -}}
{{- end -}}
